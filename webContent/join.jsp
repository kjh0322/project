...
<body>
	...
	<section>
		<div class="contentWrap">
			<div class="top">
				<div class="content">
					<p><strong>올바로병원</strong> 홈페이지 회원이 되어주세요</p>
					<span>
						회원정보를 입력해주세요.<br/>
						회원정보를 입력 후 가입이 완료됩니다.
					</span>
				</div>
		...
		<form action="join.do" method="post" name="frm">				
			<div class="main">
				<div class="middle">
					<div class="input">
						<strong><img alt="기타 그림" src="img/mypage.png">회원가입 기본정보 입력</strong>
					</div>
					
					<div class="notice">
						<span><img alt="주의사항" src="img/notice.png">아이디는 수정이 불가능합니다. 정확한 정보를 입력해주시기 바랍니다.</span>
					</div>
				</div>
