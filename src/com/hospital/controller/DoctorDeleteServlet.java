...
public class DoctorDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String code=request.getParameter("code");		// 선택한 예약 정보의 code를 가져와 code에 기억해라
		
		DoctorDAO dDao = DoctorDAO.getInstance();		// DoctorDAO 객체 생성
		dDao.deleteDoctor(code);						// DoctorDAO의 deleteDoctor 메서드에 기억한 code 값을 매개변수로 해서 의료진 정보를 삭제해라
